...
/* 注意： 如果要通过路径的形式，去引入 node_modules 中相关的文件，
 * 可以直接省略 路径前面的 node_modules 这一层目录，直接写 包的名称，然后后面跟上具体的文件路径
...
/* 在 webpack 中，默认只能处理 一部分 ES6 的新语法，一些更高级的ES6语法或者 ES7 语法，
 ...
 * }
 *  4. 了解： 目前，我们安装的 babel-preset-env, 是比较新的ES语法， 之前，
 * 我们安装的是 babel-preset-es2015, 现在，出了一个更新的 语法插件，
 * 叫做 babel-preset-env ，它包含了 所有的 和 es***相关的语法*/